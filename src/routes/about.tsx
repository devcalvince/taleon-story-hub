  ...
  return (
    <>
      ...
      <div className="mx-auto max-w-3xl space-y-8 px-4 pb-20 text-base leading-relaxed text-muted-foreground sm:px-6">
        <p>
          We create original worlds and release them in the three ways people actually experience
          stories today: reading, listening and watching. Every Taleon Original is written, produced
          and owned in-house.
        </p>
        <p>
          Our first flagship world is <span className="text-foreground">The Last Signal</span> — a
          sci-fi mystery set in Nairobi in 2047, released chapter by chapter, with narration and
          cinematic adaptations following each release.
        </p>
        <div className="grid gap-px overflow-hidden rounded-lg border border-border bg-border sm:grid-cols-3">
          {[
            ...
            <div key={i.k} className="bg-surface-2 p-6">
              <p className="font-display text-lg tracking-[0.2em] text-foreground uppercase">
                {i.k}
              </p>
        ...
        <p>
          Taleon is built for a mobile-first audience discovering stories on TikTok, Instagram and
          YouTube — and built to grow into a full storytelling ecosystem with membership, community
          and a mobile app.
        </p>
