      ...
      <div className="mx-auto grid max-w-7xl gap-10 px-4 py-14 sm:px-6 md:grid-cols-[1.4fr_1fr_1fr]">
        ...
        <nav aria-label="Footer">
          ...
          <ul className="mt-4 space-y-2 text-sm text-muted-foreground">
            ...
            <li><Link to="/audio" className="hover:text-foreground">Audio</Link></li>
            <li><Link to="/watch" className="hover:text-foreground">Watch</Link></li>
            <li><Link to="/genres" className="hover:text-foreground">Genres</Link></li>
            <li><Link to="/about" className="hover:text-foreground">About</Link></li>
            <li><Link to="/pricing" className="hover:text-foreground">Membership</Link></li>
      ...
      <div className="border-t border-border">
        <div className="mx-auto flex max-w-7xl flex-col gap-3 px-4 py-6 text-xs text-muted-foreground sm:flex-row sm:items-center sm:justify-between sm:px-6">
          ...
          <div className="flex flex-wrap gap-4">
            ...
            <Link to="/copyright" className="hover:text-foreground">Copyright</Link>
          </div>
        </div>
      </div>
    </footer>
